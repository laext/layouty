...
class Layouty extends Field
{
    /**
     * @var array
     */
    protected static $css = [
        'vendor/laext/layouty/layouty.css',
    ];
     ...
     * @var string
     */
    protected $view = 'laext-layouty::table';
    ...
    {
        if (!is_array($rows) && !$rows instanceof LayoutyRow) {
            throw new \Exception('Rows format error!');
        }
        
        $this->rows = $rows instanceof LayoutyRow ? [$rows] : $rows;
